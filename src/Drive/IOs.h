...
void InitIOs();         // IO resource Initialize
...
// 0-15 can be set, as long as there are no duplicates, refer to the list above
// If there is timer usage, avoid it!!!
/*
...
void PWM_Control(int PWM_Channel, int DutyA);       // PWM control
